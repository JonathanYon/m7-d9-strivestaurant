...
const ReservationForm = () => {
  ...
  const inputChange = (
    ...
    setReservation({
      ...reservation,
      [id]: id === "smoking" ? checked : value, //e.target.checked : e.target.value
    });
  };
      ...
      <Form className="mb-5" onSubmit={(e) => submitReservation(e)}>
        <Form.Group>
          ...
          <Form.Control
            ...
            id="name"
            onChange={(e) => inputChange(e.target.value, e.target.id)}
          />
        </Form.Group>
        <Form.Group>
        ...
        <Form.Group>
          <Form.Check
            ...
            id="smoking"
            onChange={(e) =>
              inputChange(e.target.value, e.target.id, e.target.checked)
            }
          />
        </Form.Group>
        <Form.Group>
